...
<div class="list_title">
    	...
    	<span class="layui-children-title-customer">每日新注册的用户统计</span>
</div>
	...
	<!-- 为ECharts准备一个具备大小（宽高）的Dom -->
	 <div class="table_data">
		<h4 class="table_data_title">每日新注册的用户统计</h4>
	...
	function SetChart()
	{
		require([ 'echarts', 'echarts/chart/line', 'echarts/chart/bar' // 使用柱状图就加载bar模块，按需加载
	        ...
	        $.ajax({
	            ...
	            url : "<%=request.getContextPath()%>/customerStatic/newCustomerStatisByDay",
	            dataType : "json",
	            async: false,//同步
	        ...
	        var option = {
	            ...
	            //图例配置
	            legend: {
	                data: ['用户注册'], //这里需要与series内的每一组数据的name值保持一致
	                y:"bottom"
	            },
	            //工具箱配置
	            toolbox: {
