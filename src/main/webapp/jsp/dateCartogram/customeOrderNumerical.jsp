...
<body>
	<div class="list_title">
    	...
    	<span class="layui-children-title-customer">用户下单比例</span>
	</div>
	...
	<!-- 为ECharts准备一个具备大小（宽高）的Dom -->
	 <div class="table_data">
		<h4 class="table_data_title">用户下单比例</h4>
		...
		function SetChart(){
			...
			require([ 'echarts', 'echarts/chart/line' ], function(ec) {
		        ...
		        var option = {
                        ...
                        //图例配置
                        legend: {
                            data: ['下单人数','当周会员总数','使用率'], //这里需要与series内的每一组数据的name值保持一致
                            y:"bottom"
                        },
                        //工具箱配置
                        toolbox: {
		        ...
		        $.ajax({
		            ...
		            success : function(result) {
		            	...
		            	option.series[1].data = JSON.parse(result.xArr);
		            	option.series[2].data = JSON.parse(result.iArr);
		            	option.title.text = "用户使用率";
