...
<div class="list_title">
    	...
    	<span class="layui-children-title-customer">注册会员统计</span>
</div>
	...
	<!-- 为ECharts准备一个具备大小（宽高）的Dom -->
	 <div class="table_data">
		<h4 class="table_data_title">注册会员统计</h4>
	...
	function SetChart()
	{
		require([ 'echarts', 'echarts/chart/line' ], function(ec) {// 使用柱状图就加载bar模块，按需加载
	        ...
	        $.ajax({
	            ...
	            url : "<%=request.getContextPath()%>/numericalController/gettestdata",
	            dataType : "json",
	            async: false,//同步
	            success : function(result) {
	            	if(result.code='10000'){
	                	 ...
	                	 $("#createEndTime").datebox("setValue",result.data.createEndTime);
