...
<div class="list_title">
    ...
    <span class="layui-children-title-customer">订单统计</span>
</div>
	...
	<div class="table_data">
		<h4 class="table_data_title">订单统计</h4>
...
<script type="text/javascript">
	...
	function SetChart()
	{
		require([ 'echarts', 'echarts/chart/line' ], function(ec) {// 使用柱状图就加载bar模块，按需加载
	        ...
	        $.ajax({
	            ...
	            url : "<%=request.getContextPath()%>/numericalController/gettestdataOrder",
	            dataType : "json",
	            async: false,//同步
	            success : function(result) {
	            		option.xAxis[0].data = JSON.parse(result.categories);  
	            		option.series[0].data = JSON.parse(result.values);
	                	$("#createEndTime").datebox("setValue",result.createendimeTemp);
