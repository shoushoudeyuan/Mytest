...
<div class="list_title">
    	...
    	<span class="layui-children-title-customer">每日车场出场数</span>
</div>
	...
	<div class="table_data">
		<h4 class="table_data_title">每日车场出场数</h4>
	...
	function SetChart()
	{
		require([ 'echarts', 'echarts/chart/line', 'echarts/chart/bar' // 使用柱状图就加载bar模块，按需加载
	        ...
	        $.ajax({
	            ...
	            url : "<%=request.getContextPath()%>/numericalController/parkCreateOrder",
	            dataType : "json",
	            async: false,//同步
