...
<body>
	...
	<div class="list_title">
		 ...
		 <span class="layui-children-title-customer">催款记录管理</span>
	</div>
			...
			<div class="form_item">
				<div class="form_item_inline">
					...
					<div class="form_item_input">
						<!-- 事件类型(0违章1故障2救援3催款) -->
						<input type="hidden" id="eventcategory" name="eventcategory" value="3" />
				...
				<div class="form_item_inline">
					<label class="form_item_label4">催款状态</label>
					<div class="form_item_input">
        ...
        $('#dg').datagrid({
            ...
            columns: [
                [
                    ...
                    { field: 'operator', title: '处理人',width:'10%' },
                    { field: 'assistant', title: '协助人', align: 'center',width:'10%' },
	...
	function editRecord(id){
		location.href="<%=request.getContextPath()%>/jsp/customerService/editRemindPay.jsp?serviceEventId="+id;
	}
	
	function addRecord(){
		location.href="<%=request.getContextPath()%>/jsp/customerService/editRemindPay.jsp";
		}
