...
<body>
	<div class="list_title">
		 ...
		 <span class="layui-children-title-customer">编辑催款记录</span>
	</div>
	<div class="table_data">
		<h4 class="table_data_title">编辑催款记录</h4>
			<form id="fmData">
				<input id="id" name="id" type="hidden" value="" /> 
				<input id="orderid" name="orderid" type="hidden" value="" />
				<!-- 事件类型(0违章1故障2救援3催款) -->
				<input name=eventcategory type="hidden" value="3" />
				<table class="pop_table" style="width:40%; float:left" >
					...
					<tr>
						<td>处理结果</td>
						<td><select id="dealwithresult" name="dealwithresult"
							style="width: 250px;" class="easyui-combobox">
	...
	$(function() {
		...
		$("#btnCancel").click(function(){
			location.href="<%=request.getContextPath()%>/jsp/customerService/remindPayRecordManage.jsp";
		});
		//下拉框如果不存在数据,则清空输入框
