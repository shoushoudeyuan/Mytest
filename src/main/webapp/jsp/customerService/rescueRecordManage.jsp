...
<body>
	<div class="list_title">
		 ...
		 <span class="layui-children-title-customer">救援记录管理</span>
	</div>
			...
			<div class="form_item">
				<div class="form_item_inline">
					...
					<div class="form_item_input">
						<!-- 事件类型(0违章1故障2救援3催款) -->
						<input type="hidden" id="eventcategory" name="eventcategory" value="2" />
        ...
        $('#dg').datagrid({
            ...
            columns: [
                [
                    ...
                    { field: 'eventtime', title: '救援时间' },
                    { field: 'eventaddress', title: '救援地点' },
                    { field: 'eventcase', title: '救援情况' },
	...
	function editRecord(id){
		location.href="<%=request.getContextPath()%>/jsp/customerService/editRescueRecord.jsp?serviceEventId="+id;
	}
	
	function addRecord(){
		location.href="<%=request.getContextPath()%>/jsp/customerService/editRescueRecord.jsp";
		}
