...
<body>
	<div class="list_title">
		 ...
		 <span class="layui-children-title-customer">编辑故障记录</span>
	</div>
	<div class="table_data">
		<h4 class="table_data_title">编辑故障记录</h4>
			<form id="fmData">
				<input id="id" name="id" type="hidden" value="" /> 
				<input id="orderid" name="orderid" type="hidden" value="" />
				<!-- 事件类型(0违章1故障2救援3催款) -->
				<input name=eventcategory type="hidden" value="1" />
				<table class="pop_table" style="width:40%; float:left" >
					...
					<tr>
						<td>单/双方事故</td>
						<td><input type="text" id="singleorboth" name="singleorboth"
							class="easyui-textbox" value="" style="width: 250px;" /></td>
					</tr>
					<tr>
						<td>出险情况</td>
					...
					<tr>
						<td>保险公司</td>
						<td><input type="text" id="insurancecompany"
							name="insurancecompany" class="easyui-textbox" value=""
							style="width: 250px;" /></td>
					</tr>
					<tr>
						<td>报案号</td>
						<td><input type="text" id="reportcaseno" name="reportcaseno"
							class="easyui-textbox" value="" style="width: 250px;" /></td>
					</tr>
					<tr>
						<td>联系内容</td>
						...
						<td style=" text-align:left;">订单明细
							<table id="tabOrderDetail"  border="1" bordercolor="#ccc" cellpadding="0" cellspacing="2" style="margin-top:20px;">
								<tr>
									...
									<td width="300px"><span id="sName"></span></td>
								</tr>
								<tr>
									<td>性别</td>
	...
	$(function() {
		...
		$("#btnCancel").click(function(){
			location.href="<%=request.getContextPath()%>/jsp/customerService/faultRecordManage.jsp";
		});
		//下拉框如果不存在数据,则清空输入框
