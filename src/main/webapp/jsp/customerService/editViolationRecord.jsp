...
<body>
	<div class="list_title">
		 ...
		 <span class="layui-children-title-customer">编辑违章记录</span>
	</div>
	<div class="table_data">
		<h4 class="table_data_title">编辑违章记录</h4>
			<form id="fmData">
				<input id="id" name="id" type="hidden" value="" /> 
				<input id="orderid" name="orderid" type="hidden" value="" />
				<!-- 事件类型(0违章1故障2救援3催款) -->
				<input name=eventcategory type="hidden" value="0" />
				<table class="pop_table" style="width:40%; float:left" >
					...
					<tr>
						<td>所涉金额</td>
						<td><input type="text" id="aboutamount" name="aboutamount"
							class="easyui-numberbox" data-options="min:0,precision:2" value="" style="width: 250px;" /></td>
					</tr>
					<tr>
						<td>扣除分数</td>
						<td><input type="text" id="illegalpoint" name="illegalpoint"
							class="easyui-numberbox" data-options="min:0,precision:0" value="" style="width: 250px;" /></td>
					</tr>
					<tr>
						<td>联系方式</td>
						<td>
							<select id="contactway" name="contactway"
							style="width: 250px;" class="easyui-combobox">
					...
					<tr>
						...
						<td><input type="text" id="dealwithdate" name="dealwithdate"
							class="easyui-datetimebox" value="" style="width: 250px;" /></td>
					</tr>
					<tr>
						<td>处理结果</td>
						<td>
	...
	$(function() {
		...
		$("#btnCancel").click(function(){
			location.href="<%=request.getContextPath()%>/jsp/customerService/violationRecordManage.jsp";
		});
		//下拉框如果不存在数据,则清空输入框
