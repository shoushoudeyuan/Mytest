...
import net.joystart.coupon.remote.service.IRedpacketRemoteService;

@Service(timeout=60000,retries=0,interfaceClass=IRedpacketRemoteService.class)
@Transactional
public class RedpacketRemoteServiceImpl implements IRedpacketRemoteService{
