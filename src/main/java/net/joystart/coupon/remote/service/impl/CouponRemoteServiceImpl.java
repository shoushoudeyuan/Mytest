...
import net.joystart.coupon.remote.service.ICouponRemoteService;
...
@Transactional
@Service(timeout=60000,retries=0,interfaceClass=ICouponRemoteService.class)
public class CouponRemoteServiceImpl implements ICouponRemoteService {
	...
	@Override
	public Integer updateAsync(Coupon coupon) {
	...
	public Coupon getCouponByOrderId(Integer orderId) {
		// TODO Auto-generated method stub
		return couponMapper.getCouponByOrderId(orderId);
	}
